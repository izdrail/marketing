...
namespace Cornatul\Marketing\Base\Services\Content;
...
//todo check this
use Cornatul\Marketing\Pro\Repositories\AutomationScheduleRepository;
...
class MergeContentService
{
    ...
    {
        return route('marketing.subscriptions.unsubscribe', $message->hash);
    }
    ...
    {
        return route('marketing.webview.show', $message->hash);
    }
