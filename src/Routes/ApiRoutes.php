...
namespace Cornatul\Marketing\Base\Routes;
...
class ApiRoutes
{
    ...
    {
        return function () {
            $this->name('marketing.api.webhooks.')->prefix('v1/webhooks')->namespace('\Cornatul\Marketing\Base\Http\Controllers\Api\Webhooks')->group(static function (Router $webhookRouter) {
            ...
            $this->get('v1/ping', '\Cornatul\Marketing\Base\Http\Controllers\Api\PingController@index');
        };
    }
}
