...
use Tests\MarketingTestSupportTrait;
use Tests\TestCase;
...
class SubscriberTenantRepositoryTest extends TestCase
{
    ...
    public function it_should_get_the_grow_chart_data()
    {
        ...
        // when
        $data = $this->repository->getGrowthChartData($period, MarketingPortal::currentWorkspaceId());
    ...
    public function it_should_get_the_total_number_of_subscribers_in_the_reference_period_grouped_by_date()
    {
        ...
        // when
        $runningTotal = $this->repository->getGrowthChartData($period, MarketingPortal::currentWorkspaceId())['runningTotal'];
    ...
    public function it_should_get_the_total_number_of_unsubscribers_in_the_reference_period_grouped_by_date()
    {
        ...
        // when
        $unsubscribers = $this->repository->getGrowthChartData($period, MarketingPortal::currentWorkspaceId())['unsubscribers'];
