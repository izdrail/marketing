...
class MessageTenantRepositoryTest extends TestCase
{
    ...
    public function it_should_not_count_messages_that_have_not_been_opened_yet()
    {
        ...
        // when
        $data = $this->repository->countUniqueOpensPerPeriod(MarketingPortal::currentWorkspaceId(), get_class($campaign), $campaign->id, (int)CarbonInterval::day()->totalSeconds);
    ...
    public function it_should_count_messages_that_have_been_opened_grouped_by_two_hours_period()
    {
        ...
        // when
        $data = $this->repository->countUniqueOpensPerPeriod(MarketingPortal::currentWorkspaceId(), get_class($campaign), $campaign->id, (int)CarbonInterval::hours(2)->totalSeconds);
    ...
    public function it_should_count_messages_that_have_been_opened_grouped_by_hour_period()
    {
        ...
        // when
        $data = $this->repository->countUniqueOpensPerPeriod(MarketingPortal::currentWorkspaceId(), get_class($campaign), $campaign->id, (int)CarbonInterval::hour()->totalSeconds);
