...
class TagSubscribersControllerTest extends TestCase
{
    ...
    public function the_index_gets_tag_subscribers()
    {
        ...
        $route = route('marketing.api.tags.subscribers.index', [
            'tag' => $tag->id,
        ]);
    ...
    public function a_subscriber_can_be_added_to_a_tag()
    {
        ...
        $route = route('marketing.api.tags.subscribers.store', [
            'tag' => $tag->id,
        ]);
    ...
    public function a_tags_subscribers_can_be_synced()
    {
        ...
        $route = route('marketing.api.tags.subscribers.update', [
            'tag' => $tag->id,
        ]);
    ...
    public function a_tag_can_be_deleted()
    {
        ...
        $route = route('marketing.api.tags.subscribers.destroy', [
            'tag' => $tag->id,
        ]);
