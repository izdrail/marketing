...
class TagsControllerTest extends TestCase
{
    ...
    public function a_list_of_a_workspaces_tags_can_be_retrieved()
    {
        ...
        $route = route('marketing.api.tags.index');
    ...
    public function a_single_tag_can_be_retrieved()
    {
        ...
        $route = route('marketing.api.tags.show', [
            'tag' => $tag->id,
        ]);
    ...
    {
        $route = route('marketing.api.tags.store');
    ...
    public function a_tag_can_be_updated()
    {
        ...
        $route = route('marketing.api.tags.update', [
            'tag' => $tag->id,
        ]);
    ...
    public function a_tag_can_be_deleted()
    {
        ...
        $route = route('marketing.api.tags.destroy', [
            'tag' => $tag->id,
        ]);
    ...
    public function two_workspaces_can_have_the_same_name_for_a_tag()
    {
        ...
        MarketingPortal::setCurrentWorkspaceIdResolver(static function () use ($currentWorkspaceId) {
