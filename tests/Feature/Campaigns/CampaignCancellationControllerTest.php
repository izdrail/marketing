...
class CampaignCancellationControllerTest extends TestCase
{
    ...
    {
        $campaign = Campaign::factory()->queued()->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);

        $response = $this->get(route('marketing.campaigns.confirm-cancel', ['id' => $campaign->id]));

        $response->assertViewIs('marketing::campaigns.cancel');
    }
    ...
    public function the_cancel_endpoint_cancels_a_queued_campaign()
    {
        ...
        $response = $this->post(route('marketing.campaigns.cancel', ['id' => $campaign->id]));
    ...
    {
        $campaign = Campaign::factory()->sending()->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);
    ...
    {
        $campaign = Campaign::factory()->draft()->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);
    ...
    {
        $campaign = Campaign::factory()->sent()->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);
    ...
    {
        $campaign = Campaign::factory()->cancelled()->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);
