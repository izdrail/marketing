...
class CampaignControllerTest extends TestCase
{
    ...
    {
        // given
        Campaign::factory()->count(3)->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);
    ...
    public function the_sent_index_of_campaigns_is_accessible_to_authenticated_users()
    {
        ...
        // when
        $response = $this->get(route('marketing.campaigns.sent'));
    ...
    public function sent_campaigns_appear_on_the_sent_index()
    {
        ...
        foreach ($statuses as $status) {
            ...
            $this
                ->get(route('marketing.campaigns.sent'))
                ->assertSee($campaign->name);
        }
    }
    ...
    {
        // when
        $response = $this->get(route('marketing.campaigns.create'));
    ...
    public function new_campaigns_can_be_created_by_authenticated_users()
    {
        ...
        // when
        $response = $this->post(route('marketing.campaigns.store'), $campaignStoreData);
    ...
    {
        // given
        $campaign = Campaign::factory()->create(['workspace_id' => MarketingPortal::currentWorkspaceId()]);

        // when
        $response = $this->get(route('marketing.campaigns.preview', $campaign->id));
    ...
    public function the_edit_view_is_accessible_by_authenticated_users()
    {
        ...
        // when
        $response = $this->get(route('marketing.campaigns.edit', $campaign->id));
    ...
    public function a_campaign_is_updateable_by_authenticated_users()
    {
        ...
        // when
        $response = $this->put(route('marketing.campaigns.update', $campaign->id), $campaignUpdateData);
