...
@section('content')
    ...
    @component('marketing::layouts.partials.card')
        ...
        @slot('cardBody')
            ...
            <form action="{{ route('marketing.subscribers.import.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    <div class="offset-sm-3 col-sm-9">
                        <a href="{{ route('marketing.subscribers.index') }}" class="btn btn-light">{{ __('Back') }}</a>
