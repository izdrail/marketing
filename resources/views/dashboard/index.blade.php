                ...
                <div class="card-table table-responsive">
                    <table class="table">
                        ...
                        @forelse($recentSubscribers as $subscriber)
                            <tr>
                                <td>
                                    <a href="{{ route('marketing.subscribers.show', $subscriber->id) }}">
                                        {{ $subscriber->email }}
                                    </a>
                                </td>
                                ...
                                <td><a href="{{ route('marketing.subscribers.edit', $subscriber->id) }}"
...
@push('js')
    <script src="{{ asset('vendor/marketing/js/Chart.bundle.min.js') }}"></script>
