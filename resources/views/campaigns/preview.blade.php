...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <form action="{{ route('marketing.campaigns.test', $campaign->id) }}" method="POST">
            @csrf
        ...
        <form action="{{ route('marketing.campaigns.send', $campaign->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card mb-4">
                <div class="card-header">
            ...
            <div>
                <a href="{{ route('marketing.campaigns.index') }}" class="btn btn-light">{{ __('Cancel') }}</a>
