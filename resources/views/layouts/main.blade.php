<div class="main-wrapper col p-0 min-vh-100">
                ...
                <div class="modal-body bg-purple-100 p-0">
                    ...
                    <div class="logo text-center mt-4">
                        <a href="{{ route('marketing.dashboard') }}">
                            <img src="{{ asset('/vendor/marketing/img/logo-main.png') }}" alt="Marketing Portal" width="130">
                        </a>
                    </div>
    ...
    @include('marketing::layouts.partials.header')
    ...
    <div class="main-content pl-4-half pr-4-half pb-4-half">
        ...
        @if( ! in_array(request()->route()->getName(), [
            ...
            @include('marketing::layouts.partials.errors')
        @endif

        @include('marketing::layouts.partials.success')
        @include('marketing::layouts.partials.warning')
        @include('marketing::layouts.partials.error')
